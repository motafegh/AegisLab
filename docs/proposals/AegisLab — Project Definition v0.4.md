...
**Version:** 0.4  
**Status:** Final Stage 0 review draft; scope frozen pending understanding review  
...
AegisLab supports the learner's confirmed long-term direction toward becoming an **AI Security Automation Engineer**: an engineer who integrates network defense, detection engineering, security data and evidence engineering, secure platforms, distributed systems, applied machine learning, and controlled AI agents to build defensible security automation.
...
## 5.12 Asset, identity, and environment context
...
# 9. Governing principles, policies, and maturity gates
...
| Maturity and evaluation gates | Practices required before claiming a corresponding capability level | Principle 18, capability snapshots, and external calibration when applicable |
...
## 11.4 Security data and evidence engineering
...
- AegisLab Core Charter defining the first bounded vertical slice, learning objectives, explicit exclusions, completion criteria, and expansion gate
...
## 18.1 Definition-maintenance rule

After this final review draft, new implementation details, tools, procedures, and module-specific requirements should be placed in the appropriate supporting document rather than continuously expanding the project definition.

The central definition should change only when new evidence requires a meaningful revision to AegisLab's identity, thesis, target capabilities, system or learning invariants, boundaries, known limitations, or definition of success. Such a change must be deliberate and versioned.
...
# 20. Final understanding-review questions

Before declaring the project definition version 1.0, the following should be understood and reviewed together rather than assumed:

1. Can the learner explain and defend the confirmed identity: an evidence-centered network-defense laboratory serving the AI Security Automation Engineer direction?
...
4. Are the classifications of system invariants, learning invariants, development policies, and maturity gates correct, and can the learner explain the consequences of violating each category?
...
8. Can the learner explain how provenance-backed experimental truth is constructed and why it is not assumed to be perfect?
9. Can the learner explain why agent uncertainty begins with measurable evidence conditions rather than unvalidated self-reported confidence?
